...
export function NoteCard({ note, onOpen }: {note: Note; onOpen: (note: Note) => void}) {
    return (
        <div onClick={() => onOpen(note)} className="bg-yellow-100 border border-yellow-300 rounded-lg p-4 shadow-sm hover:shadow-md cursor-pointer">
